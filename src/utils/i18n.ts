...
const productEnglish: Record<string, EnglishProductOverride> = {
  witnote: {
    ...
    privacyNote: "User-selected folders, Markdown documents, and exports stay local by default. Local MLX and local Ollama do not upload documents by default. Text is sent directly to a user-configured cloud endpoint only when the user sends a request, and attached document content requires a separate per-endpoint permission.",
    features: ["Native Swift macOS Markdown workspace", "Markdown folders as a local knowledge base", "Local MLX, Ollama, and OpenAI-compatible bring-your-own API models", "PDF / Word / EPUB conversion, bilingual reading, and writing assistance"],
    courseHooks: ["Native Swift macOS", "Local AI, Ollama, and APIs", "Markdown knowledge workspaces", "App Store release compliance"],
  },
  agentlimb: {
