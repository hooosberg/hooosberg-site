...
export const expandedProductDiaries: ArticleSeed[] = [
  ...
  ...productSeries("docktouchbar", [
    ...
    },
    {
      ...
      title: "09 · 复盘：简洁、优雅、高效，落到了哪些数字和取舍上",
      category: "产品复盘",
      excerpt: "空闲 CPU 0.0%、内存 34 MB，这是量出来的。也记录这个项目的局限、许可证的取舍，以及和 AI 一起做的体会。",
      tags: ["复盘", "性能", "许可证"],
      order: 9,
      date: "2026-09-26",
      body: [
      ...
      sections: [
        {
          heading: "高效：量出来的数字",
          paragraphs: [
            "在 M1 的 MacBook Pro 上，用 Release 版本，Touch Bar 上显示着 Dock，键鼠空闲，连续 5 次采样，每次间隔 2 秒：CPU 占用全部是 0.0%，空闲唤醒 0 次，线程 3 到 4 个，物理内存约 34 MB。空闲唤醒我用内核记录的进程计数器隔 20 秒读两次做差：新增 0 次，中断唤醒也是 0，CPU 时间 0.0 毫秒。App 体积 1.1 MB，其中包含 arm64 和 x86_64 两份。代码约 1650 行 Swift，9 个文件，没有第三方依赖。",
