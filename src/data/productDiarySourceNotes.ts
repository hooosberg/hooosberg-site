...
export const productDiarySourceNotes: Record<string, ProductDiarySourceNote> = {
  ...
  rushi: {
    ...
    records: [
      "Rushi 相关 docs 覆盖开发哲学、痛点功能清单、UI 结构、语言覆盖、定价下载、音频资源、iPad 适配、StoreKit 一次买断和开发里程碑。",
      "文本与字帖资源记录把金刚经、心经、多语言版本、柳公权金刚经和欧阳询心经等公共领域或开放来源分开处理，重点不是收集越多越好，而是降低误读和版权不确定性。",
      "佛珠系统、音频资源和静心 UI 的记录说明产品体验要服务阅读仪式，不应制造复杂负担。",
      "公开文章需要避免把内容产品写成权威解释，而是讲来源、版本、语言边界和用户阅读辅助。",
    ],
    hardProblem: "最难的是尊重宗教文本语境，同时把阅读、音频、书法字帖、iPad 空间和一次买断边界做成轻量 App。",
    reusableLesson: "公共领域内容产品要先讲清来源、版权和边界，再谈 UI、语言和商业化。",
  },
  dailyzikr: {
