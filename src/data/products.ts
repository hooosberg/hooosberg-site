...
export const products: Product[] = [
  {
    ...
    tagline: "本地优先的 Markdown 工作台；隐私任务留在 Mac，复杂任务可连接你自己的云端模型。",
    summary: "面向 macOS 的 Swift 原生 Markdown 写作工作区，支持本地文件、双语阅读与本地 MLX / Ollama 模型。",
    platforms: ["macOS", "Swift 原生", "本地 MLX AI", "Ollama", "自配 API"],
    status: ["Mac App Store", "2.0.3", "本地优先", "模型可选"],
    audience: "写作者、研究者和希望同时掌握本地隐私、模型能力与 Markdown 文件控制权的用户。",
    ...
    privacy: {
      ...
      localFirst: true,
      analytics: false,
      note: "用户选择的文件夹、Markdown 文稿和导出结果默认保留在本地；本地 MLX 与本机 Ollama 不默认上传文稿。只有用户配置自己的云端 API 并主动发送提示词，或为该接口开启“允许发送已附加的文稿内容”后，相关文本才会直接发送到该用户指定的服务。",
    },
    features: ["Swift 原生 macOS Markdown 工作台", "Markdown 文件夹与本地知识库", "本地 MLX、Ollama 与自配 OpenAI 兼容 API", "PDF / Word / EPUB 转换、双语阅读和写作辅助"],
    buildNotes: ["2.0.3 在 Swift 原生工作台中补齐本地模型、Ollama 与自配云端 API 三种模型来源。", "云端 API Key 仅存于此 Mac 的 Keychain；文稿附加发送需要针对接口单独授权。", "本地文件、模型选择、格式转换、StoreKit 和 App Store 隐私披露按同一条发布链验收。"],
    courseHooks: ["Swift 原生 macOS", "本地 AI、Ollama 与 API", "Markdown 知识工作区", "App Store 合规上架"],
  },
  {
    slug: "agentlimb",
    name: "AgentLimb",
