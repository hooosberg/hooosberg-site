...
export const products: Product[] = [
  ...
  },
  {
    ...
    privacy: privacyLocal("不联网，没有统计，没有账号。只把开关、语言和长按时长这几项偏好设置保存在你的 Mac 上。"),
    features: [
      "Touch Bar 上常驻显示 Dock：访达、固定的 App、其他正在运行的 App，顺序和系统 Dock 一致",
      "单击切换（窗口在别的桌面时自动切过去），双击隐藏，长按退出；长按时 Touch Bar 右边缘会显示“正在关闭…”和倒计时，手指不会挡住",
      "睡眠唤醒、锁屏解锁、控制条进程重启之后自动恢复",
      "最右端有一个小眼睛：点一下暂时隐藏 Dock、把 Touch Bar 还给系统（亮度、音量），10–60 秒后自动恢复；屏幕被调到全黑也不会把你锁在外面",
