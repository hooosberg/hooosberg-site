...
export const products: Product[] = [
  {
    ...
    tagline: "在本地 Markdown 工作区中写作、整理知识，并使用端侧 AI 辅助。",
    summary: "WitNote 2.0.1 是面向 macOS 的 Swift 原生 Markdown 写作与知识工作区，支持本地文件夹、格式转换、双语阅读和 MLX 本地 AI。",
    platforms: ["macOS", "Swift 原生", "本地 MLX AI"],
    status: ["Mac App Store", "2.0.1", "本地优先"],
    audience: "写作者、研究者和需要把 Markdown 文件留在自己设备上的用户。",
    ...
    privacy: privacyLocal("用户选择的文件夹、Markdown 文稿和导出结果默认保留在本地；本地 AI 推理不把文稿默认发送到托管 AI 服务。模型下载、StoreKit 和用户主动打开的外部链接会按实际操作访问网络。"),
    features: ["Swift 原生 macOS 工作台", "Markdown 文件夹与本地知识库", "MLX 本地 AI 与内置 Qwen3", "PDF / Word / EPUB 转换、双语阅读和写作辅助"],
    buildNotes: ["2.0.1 使用 Swift 原生 macOS 界面和 MLX 推理路线重构。", "内置轻量 Qwen3 模型帮助用户快速开始，其他模型按下载源和许可单独管理。", "本地文件、AI 推理、模型下载、StoreKit 和 App Store 合规作为同一条发布链验收。"],
    courseHooks: ["Swift 原生 macOS", "本地 AI 与 MLX", "Markdown 知识工作区", "App Store 重构上架"],
  },
  {
    slug: "agentlimb",
    name: "AgentLimb",
