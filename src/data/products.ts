...
export const products: Product[] = [
  {
    ...
    summary: "WitNote 2.0.3 是面向 macOS 的 Swift 原生 Markdown 写作与知识工作区，支持本地文件夹、格式转换、双语阅读、本地 MLX、Ollama 和用户自配 API 模型。",
    ...
    primaryAction: { label: "Mac App Store", url: "https://apps.apple.com/us/app/witnote-ai-writer-reader-hub/id6756833873?mt=12" },
  ...
  },
  {
    ...
    summary: "AgentLimb 是一个通用网页控制 Chrome 扩展：任何能执行命令的 AI 终端——海外侧的 Claude Code、Codex、Cursor、Trae、Windsurf，国产侧的腾讯 WorkBuddy、阿里千问办公、字节 TRAE Work、Kimi Work——都能通过一段提示词接入，用你的真实浏览器会话精准操作网页。0.2.1（b7）起同时完整支持 Windows 和 macOS。",
  ...
  },
  {
    ...
    summary: "Rushi 如是整理金刚经、心经、多语言经文、佛珠计数、静心声音和源图字帖抄经练习。基础阅读与佛珠功能免费，抄经书法练习可通过 Apple StoreKit 一次买断解锁。",
