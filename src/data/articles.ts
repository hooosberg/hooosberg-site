...
const articleSeed: ArticleSeed[] = [
  ...
  },
  {
    ...
    body: [
      ...
      "2026-05-13，DrowseBook v1.0 build 1 被 App Review 按 Guideline 2.1 - Information Needed 拒回。Submission ID 是 c4ad53e0-6663-4e4f-9fea-abfa447bf422，审核设备是 iPad Air 11-inch (M3)。",
    ...
    sections: [
      ...
      },
      {
        heading: "把拒审变成流程资产",
        paragraphs: [
          "这次经验后来沉淀进上架助手的审核拒因库和中国大陆可售性策略：提交前必须明确类别风险、可售地区、内置内容、审核备注和回退策略。尤其是中国大陆，不要默认全选。",
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        heading: "矩阵复用不是换皮",
        paragraphs: [
          "麻将跑通后，可以复用 SwiftUI、SwiftData、StoreKit、隐私政策、截图生成、上架助手流程和个人站页面结构。但下一款不能只是换主题，必须换玩法和产品身份。",
      ...
      },
      {
        heading: "秘书和各部门怎么协同",
        paragraphs: [
          "开发项目负责事实源：代码、技术文档、性能、截图、构建、上架证据。立项调查员负责机会和痛点，市场推广员负责平台文案和素材，上架助手负责审核流程，老板秘书负责把这些汇总成地图。",
          "个人站上的开发日记就是这些部门工作的公开化结果：不泄露内部路径和敏感信息，只把可分享、可学习、可复用的过程沉淀出来。"
        ],
      },
    ],
  },
...
const ensureProductDiaryDetail = (
  ...
  return [
    ...
    `所以这篇日记的结论不是“功能已经写完”，而是把一个阶段的判断公开化：哪些证据足够支撑继续推进，哪些资料还需要回到开发项目、上架助手、市场推广或运营数据里补齐。这样的记录会比单纯的发布公告更慢，但也更真实，能让产品页、开发后台和课程内容保持同一条事实线。`,
    `验收时我会把它拆成四个层次：第一层是用户路径能不能走通，第二层是异常状态有没有被诚实处理，第三层是页面上的按钮、状态、截图和文案是否对应真实发布渠道，第四层是内部台账能否说明这个判断来自哪里。只要其中一层对不上，产品看起来再完整，也不能算真正进入下一个阶段。`,
    `交接时也要保留边界：开发项目保存源码、构建、测试和技术证据；上架助手保存审核材料、回复和商店元数据；市场推广员保存公开文案、平台反馈和素材复用；App 运营数据员保存下载、销售、地区、评分评论和留存观察。产品日记只把这些事实翻译成读者能理解的过程，不替任何部门保存原始资料。`,
