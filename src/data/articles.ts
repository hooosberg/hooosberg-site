...
const videoTutorialNoteSeeds: ArticleSeed[] = [
  {
    ...
    title: "视频教程笔记 · 第 7 课：招投标报价工作区自动化",
    category: "视频教程笔记",
    diaryKind: "video",
    date: "2026-07-22",
    ...
    sections: [
      ...
      },
      {
        heading: "可复制提示词",
        paragraphs: [
          "请进入“招投标报价自动化”文件夹，先查看 01_历史项目、02_评估办法 和 03_新项目 中的原始资料。请创建 README.md，说明每个文件夹中资料的用途、不得修改的原始文件、需要识别的关键字段、处理新项目的顺序、资料缺失和规则不明确时如何标记、输出文件保存位置以及项目结束后如何进入历史资料。不要计算本次项目，不要生成 Excel 结果，不要修改任何原始文件。",
          "请进入“招投标报价自动化”文件夹，阅读 README.md，并严格按照其中的流程处理 03_新项目。读取招标文件、项目基本信息和原始报价表，优先使用本项目招标文件中明确的报价评分规则。从 01_历史项目中筛选与当前项目类型、评估办法、控制价规模和时间更接近的项目作为参考，并说明筛选依据。在 04_输出结果 中生成报价评分表、历史项目对比表和报价分析报告。不要修改任何原始文件；遇到缺失、异常或无法确定的数据，请在报告中明确标记，不要自行编造。",
          "本项目已结束。我会补充最终中标公司和中标报价。请读取 03_新项目 及我补充的最终结果，按照 README.md 的归档规则处理：将项目资料复制到 05_已完成项目；补充最终中标公司和中标价格；统一整理为可识别的历史项目资料；在归档报告中说明本项目何时可被纳入后续历史分析。不要覆盖原始文件，也不要删除已有历史项目。"
        ],
      },
    ],
  },
  {
    ...
    title: "视频教程笔记 · 第 6 课：清理 Windows 流氓软件和正规安装",
    category: "视频教程笔记",
    diaryKind: "video",
    date: "2026-07-21",
    ...
    sections: [
      ...
      },
      {
        heading: "可复制提示词",
        paragraphs: [
          "C:/Gstarsoft C:/KDubaSoftDownloads C:/Ksoftware C:/MobileEmuMaster C:/Program Files (x86)/JszTyping 帮我清理这些之前下载删除后还残留的流氓软件，并且检查注册表并且删除这些残留。",
          "帮我看看还有没有会死灰复燃的流氓软件检查下。",
          "帮我清理所有异常条目。",
          "帮我在电脑上安装金山 WPS。2019 版本可以么？帮我直接安装覆盖 2019 版本？下载多少了？"
        ],
      },
    ],
  },
  {
    ...
    sections: [
      ...
      },
      {
        heading: "可复制提示词",
        paragraphs: [
          "根据公司首页信息生成一张 A4 宣传海报。先不要着急生图，先沟通海报主题内容和文字部分，包括标题、介绍、业务介绍、公司资质、合作伙伴和联系方式；再确定图片；最后组装成具有科技感的平面设计。",
          "把文案放到根目录，然后根据文案在网站找图或者生成图。你需要根据设计需要评估哪些图片复用、哪些图片重新生成。",
          "把这一版海报保存到根目录，名称叫做“未来制造第一版海报”，格式是 jpeg，分辨率 300。后面进入大家来找茬的模式。",
          "问题修改：检查 logo 裁切、合作伙伴白底、顶部公司名称和副标题居中、业务背景框磨砂透明、背景粒子渐变、文字排版和边距。完成后导出下一版，并自己截图检查。"
        ],
      },
    ],
  },
